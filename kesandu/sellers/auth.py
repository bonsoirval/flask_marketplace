...
from kesandu.auth import bp
from kesandu.auth.forms import LoginForm, RegistrationForm, ResetPasswordRequestForm, ResetPasswordForm
from kesandu.frontend.models import User
from kesandu.auth.email import send_password_reset_email
...
def register():
    ...
    return render_template('auth/register.html', data = page_data, form = form)
